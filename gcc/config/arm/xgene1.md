...
(define_insn_reservation "xgene1_branch" 0
  (and (eq_attr "tune" "xgene1")
       (eq_attr "type" "branch"))
  "xgene1_decode1op")

(define_insn_reservation "xgene1_nop" 0
  (and (eq_attr "tune" "xgene1")
       (eq_attr "type" "no_insn"))
  "xgene1_decode1op")

(define_insn_reservation "xgene1_call" 0
  (and (eq_attr "tune" "xgene1")
       (eq_attr "type" "call"))
  "xgene1_decode2op")
...
(define_insn_reservation "xgene1_f_store" 0
  (and (eq_attr "tune" "xgene1")
...
(define_insn_reservation "xgene1_store_pair" 1
  (and (eq_attr "tune" "xgene1")
       (eq_attr "type" "store2"))
...
; shift/rotate can only issue on IXB
...
(define_insn_reservation "xgene1_neon_load1" 11
  ...
  "xgene1_decode2op,(xgene1_fsu+xgene1_ld)")

(define_insn_reservation "xgene1_neon_load1_2reg" 12
  (and (eq_attr "tune" "xgene1")
       (eq_attr "type" "neon_load1_2reg, neon_load1_2reg_q"))
  "xgene1_decode2op,(xgene1_fsu+xgene1_ld)*2")

(define_insn_reservation "xgene1_neon_store1" 1
  (and (eq_attr "tune" "xgene1")
       (eq_attr "type" "neon_store1_1reg, neon_store1_1reg_q"))
  "xgene1_decode2op,(xgene1_fsu+xgene1_st)")

(define_insn_reservation "xgene1_neon_store1_2reg" 2
  (and (eq_attr "tune" "xgene1")
       (eq_attr "type" "neon_store1_2reg, neon_store1_2reg_q"))
  "xgene1_decode2op,(xgene1_fsu+xgene1_st)*2")
