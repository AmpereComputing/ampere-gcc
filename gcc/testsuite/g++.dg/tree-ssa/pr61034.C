// { dg-do compile }
// { dg-options "-O2 -fdump-tree-fre5 -fdump-tree-optimized -fdelete-null-pointer-checks --param early-inlining-insns=14 --param max-inline-insns-single=200" }
...
// { dg-final { scan-tree-dump-times ";; Function" 1 "fre5" } }
// { dg-final { scan-tree-dump-times "unreachable" 11 "fre5" } }
...
// { dg-final { scan-tree-dump-times "free" 10 "fre5" { target x86_64-*-* i?86-*-* } } }
// { dg-final { scan-tree-dump-times "free" 14 "fre5" { target aarch64-*-* ia64-*-* arm-*-* hppa*-*-* sparc*-*-* powerpc*-*-* alpha*-*-* } } }
