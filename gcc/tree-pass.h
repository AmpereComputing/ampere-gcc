...
extern gimple_opt_pass *make_pass_gen_builtin (gcc::context *ctxt);
...
extern gimple_opt_pass *make_pass_cso (gcc::context *ctxt);
...
extern simple_ipa_opt_pass *make_pass_ipa_wpt_local_optimizations (gcc::context *ctxt);
...
extern ipa_opt_pass_d *make_pass_ipa_sizeof (gcc::context *ctxt);
extern ipa_opt_pass_d *make_pass_ipa_sra (gcc::context *ctxt);
extern ipa_opt_pass_d *make_pass_ipa_icf (gcc::context *ctxt);
extern ipa_opt_pass_d *make_pass_ipa_devirt (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_cso (gcc::context *ctxt);
extern ipa_opt_pass_d *make_pass_ipa_odr (gcc::context *ctxt);
extern ipa_opt_pass_d *make_pass_ipa_reference (gcc::context *ctxt);
extern ipa_opt_pass_d *make_pass_ipa_pure_const (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_calloc_type_specialization (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_void_ptr_param_specialization (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_alignment_analysis_and_transformation (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_eliminate_cast (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_retyper (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_type_escape_analysis (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_dead_field_elimination (gcc::context *ctxt);
...
extern simple_ipa_opt_pass *make_pass_ipa_struct_dco (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_pta (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_field_merge (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_array_dse (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_tm (gcc::context *ctxt);
extern simple_ipa_opt_pass *make_pass_ipa_localize_var (gcc::context *ctxt);
...
extern simple_ipa_opt_pass *make_pass_ipa_wpt_modref (gcc::context *ctxt);
